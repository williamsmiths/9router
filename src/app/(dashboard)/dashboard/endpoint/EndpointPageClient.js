...
export default function APIPageClient({ machineId }) {
  ...
  const unsafeReason = !requireLogin
    ? "Enable \"Require login\" and set a custom password in Profile."
    : "Change the default dashboard password in Profile.";
        ...
        {isLoginUnsafe && (
          <div className="mt-4">
            <SecurityWarning
              ...
              action={{ label: "Open Profile", href: "/dashboard/profile" }}
            />
          </div>
        )}

        <p className="mt-3 text-xs text-text-muted font-mono">Machine ID: {machineId}</p>
      </Card>
